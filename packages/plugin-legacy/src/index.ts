  ...
  const legacyGenerateBundlePlugin: Plugin = {
    ...
    async generateBundle(opts, bundle) {
      ...
      if (!isLegacyBundle(bundle, opts)) {
        ...
        isDebug &&
          console.log(
            `[@kolibryjs/plugin-legacy] modern polyfills:`,
            modernPolyfills,
          )
      ...
      if (legacyPolyfills.size) {
        ...
        isDebug &&
          console.log(
            `[@kolibryjs/plugin-legacy] legacy polyfills:`,
            legacyPolyfills,
          )
  ...
  const legacyPostPlugin: Plugin = {
    ...
    configResolved(_config) {
      if (_config.build.lib) {
        throw new Error('@kolibryjs/plugin-legacy does not support library mode.')
      }
      config = _config
      ...
      isDebug && console.log(`[@kolibryjs/plugin-legacy] targets:`, targets)
