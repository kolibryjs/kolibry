    ...
    generateBundle({ format }, bundle) {
      ...
      function createChunk(chunk: OutputChunk): ManifestChunk {
        ...
        if (chunk.kolibryMetadata?.importedCss.size) {
          manifestChunk.css = [...chunk.kolibryMetadata.importedCss]
        }
        if (chunk.kolibryMetadata?.importedAssets.size) {
          manifestChunk.assets = [...chunk.kolibryMetadata.importedAssets]
        }
