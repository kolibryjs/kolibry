...
export const workerAssetUrlRE = /__KOLIBRY_WORKER_ASSET__([a-z\d]{8})__/g
...
function encodeWorkerAssetFileName(
   ...
   return `__KOLIBRY_WORKER_ASSET__${hash}__`
}
   ...
   return {
         ...
         if (query && query[WORKER_FILE_ID] != null) {
            ...
            if (workerType === 'classic') {
               ...
               if (isBuild) {
                  ...
                  // so we copy /@kolibry/env code of server transform result into file header
      ...
      renderChunk(code, chunk, outputOptions) {
         ...
         if (code.match(workerAssetUrlRE)) {
            ...
            // Replace "__KOLIBRY_WORKER_ASSET__5aa0ddc0__" using relative paths
            const workerMap = workerCache.get(config.mainConfig || config)!
      ...
      // @ts-expect-error asset emits are skipped in legacy bundle
         if (opts.__kolibry_skip_asset_emit__ || isWorker)
            return
