...
export function logError(server: KolibryDevServer, err: RollupError): void {
...
export function errorMiddleware(
  ...
  return function kolibryErrorMiddleware(err: RollupError, _req, res, next) {
    logError(server, err)
      ...
      res.end(`
        ...
        <html lang="en">
          <head>
            ...
            <title>Error</title>
            <script type="module">
              import { ErrorOverlay } from '/@kolibry/client'
