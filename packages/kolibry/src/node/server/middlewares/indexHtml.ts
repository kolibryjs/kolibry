...
import type { KolibryDevServer, ResolvedConfig } from '../..'
...
function getHtmlFilename(url: string, server: KolibryDevServer) {
...
function processNodeUrl(attr: Token.Attribute,
...
const devHtmlHook: IndexHtmlTransformHook = async (
   ...
   if (!trailingSlash && fs.existsSync(filename)) {
      ...
      // There are users of kolibry.transformIndexHtml calling it with url '/'
...
export function indexHtmlMiddleware(
   ...
   return async function kolibryIndexHtmlMiddleware(req, res, next) {
...
function preTransformRequest(server: KolibryDevServer, url: string, base: string) {
