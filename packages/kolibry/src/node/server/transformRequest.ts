...
import type { KolibryDevServer, ModuleNode } from '..'
import {
   blankReplacer,
   cleanUrl,
   createDebugger,
...
const debugLoad = createDebugger('kolibry:load')
const debugTransform = createDebugger('kolibry:transform')
const debugCache = createDebugger('kolibry:cache')
...
async function loadAndTransform(
   ...
   const prettyUrl = (debugLoad || debugTransform)
