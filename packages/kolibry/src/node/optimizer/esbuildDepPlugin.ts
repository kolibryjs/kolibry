...
const externalWithConversionNamespace =
  'kolibry:dep-pre-bundle:external-conversion'
const convertedExternalPrefix = 'kolibry-dep-pre-bundle-external:'

const cjsExternalFacadeNamespace = 'kolibry:cjs-external-facade'
const nonFacadePrefix = 'kolibry-cjs-external-facade:'
...
export function esbuildDepPlugin(
  ...
  // and it's unlikely for the core Kolibry process to traverse into node_modules again
...
module.exports = Object.create(new Proxy({}, {
  get(_, key) {
    if (
      ...
      console.warn(\`Module "${path}" has been externalized for browser compatibility. Cannot access "${path}.\${key}" in client code. See http://kolibry.zip/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.\`)
    }
  }
}))`,
            }
