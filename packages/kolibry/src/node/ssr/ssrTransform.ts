...
export const ssrModuleExportsKey = '__kolibry_ssr_exports__'
export const ssrImportKey = '__kolibry_ssr_import__'
export const ssrDynamicImportKey = '__kolibry_ssr_dynamic_import__'
export const ssrExportAllKey = '__kolibry_ssr_exportAll__'
export const ssrImportMetaKey = '__kolibry_ssr_import_meta__'
...
async function ssrTransformScript(
   ...
   function defineImport(source: string) {
      deps.add(source)
      const importId = `__kolibry_ssr_import_${uid++}__`
...
function isStaticPropertyKey(node: _Node, parent: _Node) {
