...
const debug = createDebugger('kolibry:ssr-external')
...
export function cjsSsrResolveExternals(
   ...
   // ensure `kolibry/dynamic-import-polyfill` is bundled
   ssrExternals.delete('kolibry')
...
// is used reverting to the Kolibry SSR externalization heuristics
